                ...
                <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-white rounded-lg shadow-md">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            ...
                            <Link to={"/create-account"} className="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium ml-2" href="../examples/html/signup.html">
                                Sign up here
                            </Link>
                        </p>
                    </div>
